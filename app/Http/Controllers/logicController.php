    ...
    public function toReadableJSON($json)
    {
        ...
        while ($date = current($json)) {
            ...
            foreach ($date as $subject) {
                ...
                switch ($subject->date) {
                    case "1":
                        $beginningDate = "20180812";
                        break;
                    case "2":
                        $beginningDate = "20180806";
                        break;
                    case "3":
                        $beginningDate = "20180807";
                        break;
                    case "4":
                        $beginningDate = "20180808";
                        break;
                    case "5":
                        $beginningDate = "20180809";
                        break;
                    case "6":
                        $beginningDate = "20180810";
                        break;
                    case "7":
                        $beginningDate = "20180811";
                        break;
                }
